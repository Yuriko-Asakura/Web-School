...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('school_web', '0002_rename_user_users'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='courses',
            name='ID_User',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school_web.users1'),
        ),
        migrations.AlterField(
            model_name='usercourses',
            name='ID_User',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school_web.users1'),
        ),
        migrations.AlterField(
